...
class OdooAPI:
    ...
    def delete_employee(self, api_model_name: str, odoo_object, api_uid, api_password, employee_id):
        """
        Deletes an employee from the Odoo API.
        ...
        return self.__make_query(
            api_model_name, odoo_object, api_uid, api_password, 'unlink', [[int(employee_id)]], None
        )


def delete_employee_from_odoo(odoo_object, odoo_uid, odoo_auth, employee_id_on_odoo):
    odoo_api.delete_employee(ODOO_MODEL_NAME, odoo_object, odoo_uid, odoo_auth.api_password, employee_id_on_odoo)
    print("Deleted: ", employee_id_on_odoo)
...
print('Enter the id of employee on Odoo to delete:')
employee_id_on_odoo = int(input())

delete_employee_from_odoo(odoo_object, odoo_uid, odoo_auth, employee_id_on_odoo)